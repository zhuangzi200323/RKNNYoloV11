...
Java_com_sq_rknn_rknnyolov11_YoloV11Detect_init(JNIEnv *env, jobject thiz, jstring jmodel_path,
...
JNIEXPORT jboolean JNICALL
Java_com_sq_rknn_rknnyolov11_YoloV11Detect_detect(JNIEnv *env, jobject thiz, jobject jbitmap) {
...
//    for (int i = 0; i < 10; ++i) {
    ...
    ret = use_zero_copy ?
          inference_yolo11_model_zerocopy(&rknn_app_ctx, &src_image, &od_results)
...
Java_com_sq_rknn_rknnyolov11_YoloV11Detect_detect2(JNIEnv *env, jobject thiz, jobject jbitmap) {
    AndroidBitmapInfo dstInfo;
    ...
    // 获取 Java 类和构造函数
    jclass detectionResultClass = env->FindClass("com/sq/rknn/rknnyolov11/DetectionResult");
    jclass objectResultClass = env->FindClass("com/sq/rknn/rknnyolov11/DetectionResult$ObjectResult");
    ...
    jmethodID addMethod = env->GetMethodID(detectionResultClass, "addObjectResult", "(Lcom/sq/rknn/rknnyolov11/DetectionResult$ObjectResult;)V");
...
JNIEXPORT jboolean JNICALL
Java_com_sq_rknn_rknnyolov11_YoloV11Detect_release(JNIEnv *env, jobject thiz) {
    deinit_post_process();
