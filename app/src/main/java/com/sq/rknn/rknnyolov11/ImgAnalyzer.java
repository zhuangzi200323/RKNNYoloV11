...
public class ImgAnalyzer implements ImageAnalysis.Analyzer {
    ...
    private final YoloV11Detect yolov11Detect;
    private final Callback callBack;

    Set<String> resultSet = new HashSet<>();

    public ImgAnalyzer(YoloV11Detect yolov11Detect, Callback callBack) {
        this.yolov11Detect = yolov11Detect;
    ...
    public void analyze(ImageProxy image) {
        ...
        AsyncTask.execute(() -> {
            ...
            if (bitmap != null) {
                DetectionResult result = (DetectionResult) yolov11Detect.detect2(bitmap);
                if (result != null) {
