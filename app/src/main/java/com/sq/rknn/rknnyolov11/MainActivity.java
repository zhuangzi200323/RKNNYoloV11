...
import com.sq.rknn.rknnyolov11.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private YoloV11Detect yolov11Detect = new YoloV11Detect();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        try {
            ...
            boolean retInit = yolov11Detect.init(AssetHelper.assetFilePath(this, "yolo11n.rknn"),
                    AssetHelper.assetFilePath(this, labelFile), false);
            if (!retInit) {
                Log.e(TAG, "YoloV11Detect Init failed");
            }
        } catch (IOException e) {
...
//    }
    ...
    private void setImgAnalyzer() {
        ...
        imageAnalysis.setAnalyzer(backgroundExecutor, new ImgAnalyzer(yolov11Detect, this::updateUI));
    }
    ...
    protected void onDestroy() {
        ...
        boolean retInit = yolov11Detect.release();
        if (!retInit) {
            Log.e(TAG, "YoloV11Detect Release failed");
        }
    }
}